...
<template>
        ...
        <div ref="seekerContainer" class="flex items-center ml-2 w-[150px] relative mt-2 mb-[23px]" @mouseenter="isHover = true"
            ...
            <div class="pointer-events-none mt-[6px] absolute h-[4px] z-10 inset-y-0 left-0 w-0"
                :style="`width: ${vol}%;`" :class="isHover ? 'bg-green-500' : 'bg-white'" />
